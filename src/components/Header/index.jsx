...
import FormComponent from "../Form/SignInForm/FormComponent";
...
export default function Header({ logoSrc, variant }) {
  ...
  const test = () => {
    ...
    console.log("accessTokenLength", accessTokenLength);
          ...
          <div className="container">
            <div className="cs_main_header_in">
              <div
                ...
                onClick={() => console.log("UserState", UserState)}
              >
                ...
                <nav className="cs_nav">
                  ...
                  >
                    ...
                    <li
                      ...
                      className={IsAdmin && ValidAccessToken ? "" : "d-none"}
                    >
                    ...
                    <li
                      onClick={OnCloseSideBar}
                      className={ValidAccessToken ? "" : "d-none"}
                    >
      ...
      <div className={`cs_sidenav ${sideNav ? "active" : ""}`}>
        ...
        <div className="cs_sidenav_in">
          ...
          <div className="cs_logo_box">
            <img src="/images/library_logo.png" alt="Logo" />
            <div className="cs_height_15" />
            <h3
              className={`cs_fs_24 cs_semibold mb-0 ${
                ValidAccessToken ? "d-none" : ""
              }`}
            >
              {accessToken ? `Login with other user` : `Login Here`}
            </h3>
          </div>
          ...
          <div className="container">
            <div className="cs_header_search_box">
              ...
              <button
                ...
                onClick={() => setSearchToggle(!searchToggle)}
              >
                <img src="/images/library_logo.png" alt="Close" />
              </button>
            </div>
          </div>
        </div>
